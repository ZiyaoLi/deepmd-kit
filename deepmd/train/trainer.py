...
from deepmd.descriptor import DescrptSeConvGeo
...
def _generate_descrpt_from_param_dict(descrpt_param):
    ...
    elif descrpt_type == 'se_conv_geo':
        descrpt = DescrptSeConvGeo(**descrpt_param)
    else :
    ...
    def train (self, train_data, valid_data=None) :
        ...
        while cur_batch < stop_batch :
            ...
            if self.display_in_training and is_first_step:
                ...
                log.info("get_dim_out = %d" % self.descrpt.get_dim_out())
